...
import { deleteHackathonAnalysis } from "../deleteHackathonAnalysis";
...
describe("deleteHackathonAnalysis", () => {
  ...
  it("should delete from documents table when document exists", async () => {
    ...
    const result = await deleteHackathonAnalysis(mockAnalysisId);
  ...
  it("should not delete parent idea when deleting document", async () => {
    ...
    await deleteHackathonAnalysis(mockAnalysisId);
