  ...
  return (
    <div className="relative w-full mb-8 p-8 bg-gradient-to-br from-purple-900/30 to-black/50 rounded-lg border-2 border-orange-500/50 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-0 right-1/4 w-1 h-full bg-gradient-to-b from-orange-500 via-transparent to-transparent animate-pulse" style={{ animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="relative z-10">
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-purple-800/80 to-purple-900/80 border-2 border-orange-500/50 rounded-lg p-4 hover:border-orange-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/50 cursor-help">
                  ...
                  {/* Tooltip */}
                  {element.description && (
                    <div className={`absolute bottom-full ${tooltipPositionClass} mb-2 w-56 max-w-[85vw] md:w-64 opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none z-50`}>
                      <div className="bg-gray-900 text-white text-[11px] rounded-md p-2.5 shadow-2xl border border-orange-500/60">
                        ...
                        <div className="relative">
                          <p className="font-semibold text-orange-400 text-xs mb-1 line-clamp-1">{element.name}</p>
                          <p className="text-gray-300 leading-snug line-clamp-3">{element.description}</p>
                        </div>
                      </div>
                    </div>
                  )}
        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative bg-gradient-to-br from-orange-600 to-red-600 rounded-lg p-6 border-4 border-orange-400 shadow-2xl shadow-orange-500/50 max-w-md animate-bounce-slow">
            ...
            <div className="absolute -top-1 -right-1 w-3 h-3 bg-yellow-400 rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
            <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-yellow-400 rounded-full animate-ping" style={{ animationDelay: '1s' }} />
            <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-yellow-400 rounded-full animate-ping" style={{ animationDelay: '1.5s' }} />
          </div>
        </div>
