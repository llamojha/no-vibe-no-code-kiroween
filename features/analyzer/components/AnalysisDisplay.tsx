              ...
              <div className="flex flex-wrap gap-2">
                {ideaId && (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 text-sm font-medium uppercase tracking-wider text-teal-300 bg-teal-500/10 border border-teal-600 rounded-none hover:bg-teal-500/20 hover:text-teal-200 hover:border-teal-500 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                    ...
                    <span>
                      {t("goToIdeaPanelButton") || "Go to Idea Panel"}
                    </span>
                  </button>
                )}
                <button
