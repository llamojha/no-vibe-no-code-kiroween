...
const TTSPlayer: React.FC<TTSPlayerProps> = ({
  ...
  const [loadedAudioBase64, setLoadedAudioBase64] = useState<string | null>(
    null
  );
  ...
  const disabledButtonClasses =
    "bg-primary/30 text-slate-600 cursor-not-allowed";
