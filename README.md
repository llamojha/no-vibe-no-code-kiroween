...
## Quick Start: Open Source Mode

Run the full application locally with just a Gemini API key. No database setup required.

**Prerequisites:** Node.js 18+, [Gemini API Key](https://aistudio.google.com/app/apikey)
...
Open [http://localhost:3000](http://localhost:3000) and login with default credentials: **kiro** / **kiro**

For detailed setup instructions and customization options, see [Self-Hosted Guide](docs/SELF_HOSTED.md).

## Quick Start: Full Mode (Supabase)

For production deployments with multi-user support and persistent database storage.
