...
import { generateStartupIdeaPrompt, generateHackathonProjectPrompt, type Locale as PromptLocale } from '@/lib/prompts';
...
export class GoogleAIAdapter {
  ...
  private buildHackathonAnalysisPrompt(
    ...
    const promptLocale: PromptLocale = locale.value as PromptLocale;
    const prompt = generateHackathonProjectPrompt(projectDescription, kiroUsage, category, promptLocale);
