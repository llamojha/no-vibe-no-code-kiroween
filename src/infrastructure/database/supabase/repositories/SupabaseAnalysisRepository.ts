...
export class SupabaseAnalysisRepository implements IAnalysisRepository {
  ...
  async save(analysis: Analysis): Promise<Result<Analysis, Error>> {
    ...
    try {
      ...
      if (!data) {
        logger.error(LogCategory.DATABASE, "No data returned from insert", {
          duration,
        });
        return failure(
          new DatabaseQueryError("No data returned from insert", null, "INSERT")
        );
      }
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error saving analysis",
          error,
          "INSERT"
        )
      );
  ...
  async update(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to update analysis", error, "UPDATE")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error updating analysis", error)
      );
    }
  }
  ...
  async delete(
    ...
    try {
      // If requesting user is provided, verify ownership before deletion
      if (requestingUserId) {
        ...
        if (fetchError) {
          if (fetchError.code === "PGRST116") {
            return failure(new RecordNotFoundError("Analysis", id.value));
          }
          return failure(
            new DatabaseQueryError(
              "Failed to fetch analysis for authorization",
              fetchError,
              "SELECT"
            )
          );
        ...
        if (existingData && existingData.user_id !== requestingUserId.value) {
          logger.warn(LogCategory.DATABASE, "Unauthorized delete attempt", {
            analysisId: id.value,
            analysisUserId: existingData.user_id,
            requestingUserId: requestingUserId.value,
          });
          return failure(
            new AuthorizationError(
              "Cannot delete analysis belonging to another user"
            )
          );
        }
      }
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to delete analysis", error, "DELETE")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error deleting analysis", error)
      );
    }
  }
  ...
  async deleteAllByUserId(userId: UserId): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to delete user analyses",
            error,
            "DELETE"
          )
        );
      ...
      return failure(
        new DatabaseQueryError("Unexpected error deleting user analyses", error)
      );
    }
  }
    ...
    try {
      ...
      const promises = updates.map(async ({ id, score }) => {
        ...
        if (error) {
          throw new DatabaseQueryError(
            `Failed to update score for analysis ${id.value}`,
            error,
            "UPDATE"
          );
        }
      ...
      return failure(
        error instanceof Error
          ? error
          : new DatabaseQueryError("Unexpected error updating scores", error)
      );
    }
  }
  ...
  async saveMany(entities: Analysis[]): Promise<Result<Analysis[], Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to save multiple analyses",
            error,
            "INSERT"
          )
        );
      ...
      const savedAnalyses = data.map((dao) =>
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error saving multiple analyses",
          error
        )
      );
    }
  ...
  async deleteMany(ids: AnalysisId[]): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to delete multiple analyses",
            error,
            "DELETE"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error deleting multiple analyses",
          error
        )
      );
    }
  ...
  async findById(
    ...
    try {
      ...
      if (
        ...
        logger.warn(LogCategory.DATABASE, "Unauthorized access attempt", {
          analysisId: id.value,
        ...
        return failure(
          new AuthorizationError(
            "Cannot access analysis belonging to another user"
          )
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error finding analysis by ID", error)
      );
    }
  }
  ...
  async exists(id: AnalysisId): Promise<Result<boolean, Error>> {
    try {
      ...
      if (error) {
        ...
        return failure(
          new DatabaseQueryError(
            "Failed to check analysis existence",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error checking analysis existence",
          error
        )
      );
    }
  ...
  async count(): Promise<Result<number, Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to count analyses", error, "COUNT")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error counting analyses", error)
      );
    }
  }
  ...
  async findAll(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to find all analyses", error, "SELECT")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error finding all analyses", error)
      );
    }
  }
  ...
  async findByIds(ids: AnalysisId[]): Promise<Result<Analysis[], Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses by IDs",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses by IDs",
          error
        )
      );
    }
  ...
  async findWhere(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses with criteria",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses with criteria",
          error
        )
      );
    }
  ...
  async findWhereWithPagination(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses with criteria and pagination",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses with criteria and pagination",
          error
        )
      );
    }
  ...
  async findAllByUserId(userId: UserId): Promise<Result<Analysis[], Error>> {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses by user ID",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses by user ID",
          error
        )
      );
    }
  ...
  async findByUserIdPaginated(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses by user ID with pagination",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses by user ID with pagination",
          error
        )
      );
    }
  ...
  /**
   * Optimized query for dashboard cards
   * Selects only the fields needed for dashboard display to reduce data transfer
  ...
  async findByUserIdForDashboard(
    ...
    >
  > {
    logger.debug(LogCategory.DATABASE, "Fetching dashboard analyses", {
      userId: userId.value,
      page: options.page,
      limit: options.limit,
    ...
    try {
      ...
      if (duration > 1000) {
        logger.warn(LogCategory.DATABASE, "Slow dashboard query execution", {
          duration,
          userId: userId.value,
          page: options.page,
          limit: options.limit,
      ...
      if (error) {
        logger.error(
          LogCategory.DATABASE,
          "Failed to fetch dashboard analyses",
          {
            error: error.message,
            code: error.code,
            duration,
        ...
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses for dashboard",
            error,
            "SELECT"
          )
        );
      ...
      logger.info(
        LogCategory.DATABASE,
        "Dashboard analyses fetched successfully",
        {
      ...
      logger.error(
        LogCategory.DATABASE,
        "Unexpected error fetching dashboard analyses",
        {
          error: error instanceof Error ? error.message : String(error),
          duration: Date.now() - startTime,
        }
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses for dashboard",
          error
        )
      );
    }
  ...
  async searchByUser(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to search analyses by user",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error searching analyses by user",
          error
        )
      );
    }
  ...
  > {
    try {
      ...
      if (totalError) {
        return failure(
          new DatabaseQueryError(
            "Failed to get total analysis count",
            totalError,
            "COUNT"
          )
        );
      ...
      if (ideaError) {
        return failure(
          new DatabaseQueryError(
            "Failed to get idea analysis count",
            ideaError,
            "COUNT"
          )
        );
  ...
  > {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to get score stats by user",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error getting score stats by user",
          error
        )
      );
    }
  ...
  async findByCategory(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses by category",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses by category",
          error
        )
      );
    }
  ...
  async findHighQuality(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find high quality analyses",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding high quality analyses",
          error
        )
      );
    }
  ...
  async findRecent(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find recent analyses",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding recent analyses",
          error
        )
      );
    }
  ...
  async search(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to search analyses", error, "SELECT")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error searching analyses", error)
      );
    }
  }
  ...
  async findByUserAndCategory(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses by user and category",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses by user and category",
          error
        )
      );
    }
  ...
  > {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to get user analysis stats",
            error,
            "SELECT"
          )
        );
      ...
      const completedCount = analyses.filter(
        (a) =>
          a.analysis && typeof a.analysis === "object" && "score" in a.analysis
      ).length;
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error getting user analysis stats",
          error
        )
      );
    }
  ...
  > {
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError("Failed to get global stats", error, "SELECT")
        );
      }
      ...
      return failure(
        new DatabaseQueryError("Unexpected error getting global stats", error)
      );
    }
  }
  ...
  async findSimilar(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find similar analyses",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding similar analyses",
          error
        )
      );
    }
  ...
  async findNeedingAttention(
    ...
    try {
      ...
      if (error) {
        return failure(
          new DatabaseQueryError(
            "Failed to find analyses needing attention",
            error,
            "SELECT"
          )
        );
      ...
      return failure(
        new DatabaseQueryError(
          "Unexpected error finding analyses needing attention",
          error
        )
      );
    }
