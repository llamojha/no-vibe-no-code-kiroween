...
export class SupabaseUserRepository implements IUserRepository {
  ...
  async update(user: User): Promise<Result<User, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to update user', error, 'UPDATE'));
      }
  ...
  async delete(id: UserId): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to delete user', error, 'DELETE'));
      }
  ...
  async activate(id: UserId): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to activate user', error, 'UPDATE'));
      }
  ...
  async deactivate(id: UserId): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to deactivate user', error, 'UPDATE'));
      }
  ...
  async updateLastLogin(id: UserId, loginTime: Date): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to update last login', error, 'UPDATE'));
      }
  ...
  async deactivateInactiveUsers(days: number): Promise<Result<number, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to deactivate inactive users', error, 'SELECT'));
      }
  ...
  async deleteMany(ids: UserId[]): Promise<Result<void, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to delete multiple users', error, 'DELETE'));
      }
  ...
  async exists(id: UserId): Promise<Result<boolean, Error>> {
    try {
      ...
      if (error) {
        ...
        return failure(new DatabaseQueryError('Failed to check user existence', error, 'SELECT'));
      }
  ...
  async count(): Promise<Result<number, Error>> {
    try {
      ...
      if (error) {
        return failure(new DatabaseQueryError('Failed to count users', error, 'COUNT'));
      }
  ...
  async findAll(params: PaginationParams): Promise<Result<PaginatedResult<User>, Error>> {
    try {
  ...
  async findWhere(criteria: Record<string, unknown>): Promise<Result<User[], Error>> {
    try {
  ...
  async findActive(params: PaginationParams): Promise<Result<PaginatedResult<User>, Error>> {
    try {
  ...
  async findInactive(params: PaginationParams): Promise<Result<PaginatedResult<User>, Error>> {
    try {
